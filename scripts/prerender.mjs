...
const ROUTES = [
  ...
  '/compare',
  ...['taplio','vista-social','hootsuite','buffer','typefully','supergrow','brandled','authoredup','authoritymax','later','publer','planable','zopto','dux-soup'].map(s => `/compare/somyra-vs-${s}`),
  '/alternatives',
  ...['taplio','vista-social','hootsuite','buffer','typefully','supergrow','brandled','authoredup','authoritymax','later','publer','planable','zopto','dux-soup'].map(s => `/alternatives/somyra-vs-${s}`),
  '/terms',
  '/privacy',
  '/contact',
];
